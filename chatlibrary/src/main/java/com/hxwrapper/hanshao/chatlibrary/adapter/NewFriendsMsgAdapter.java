 ...
 */
package com.hxwrapper.hanshao.chatlibrary.adapter;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (msg != null) {
			...
			if (msg.getStatus() == InviteMessage.InviteMesageStatus.BEAGREED) {
				...
				holder.status.setBackgroundResource(R.drawable.shape_friend_gay);
				...
				try {
					...
					((Activity) context).runOnUiThread(new Runnable() {
						...
						public void run() {
							...
							buttonRefuse.setBackgroundResource(R.drawable.shape_friend_gay);
